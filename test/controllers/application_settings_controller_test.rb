...
class ApplicationSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create application_setting" do
    assert_difference('ApplicationSetting.count') do
      post application_settings_url, params: { application_setting: { setting_name: @application_setting.setting_name, value: @application_setting.value } }
    end
  ...
  test "should update application_setting" do
    patch application_setting_url(@application_setting), params: { application_setting: { setting_name: @application_setting.setting_name, value: @application_setting.value } }
