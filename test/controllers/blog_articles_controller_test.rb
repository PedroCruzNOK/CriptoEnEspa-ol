...
class BlogArticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_article" do
    assert_difference('BlogArticle.count') do
      post blog_articles_url, params: { blog_article: { content: @blog_article.content, image_url: @blog_article.image_url, source: @blog_article.source, title: @blog_article.title, url: @blog_article.url } }
    end
  ...
  test "should update blog_article" do
    patch blog_article_url(@blog_article), params: { blog_article: { content: @blog_article.content, image_url: @blog_article.image_url, source: @blog_article.source, title: @blog_article.title, url: @blog_article.url } }
